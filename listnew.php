        ...
        <div class="bg-gray-800 shadow-xl h-16 fixed bottom-0 mt-12 md:relative md:h-screen z-10 w-full md:w-48">
            ...
            <div class="md:mt-12 md:w-48 md:fixed md:left-0 md:top-0 content-center md:content-start text-left justify-between">
                <ul class="list-reset flex flex-row md:flex-col py-0 md:py-3 px-1 md:px-2 text-center md:text-left">
                    ...
                    <li class="mr-3 flex-1">
                        <a href="listuser.php" class="block py-1 md:py-3 pl-0 md:pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-gray-800 hover:border-red-500">
                            <i class="fa fa-wallet pr-0 md:pr-3"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-gray-600 md:text-gray-400 block md:inline-block">User</span>
                        </a>
                    </li>
        ...
        <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-2 pb-24 md:pb-5">
            ...
            <table class="table-auto w-full">
                        ...
                        <tr class="bg-blue-500 text-white shadow-lg">
                            ...
                            <th class="py-3 px-4 text-left">Intro</th>z
                        ...
                        <tr class="hover:bg-gray-100">
                            <td class="px-4 py-3"><?php echo $row['new_id'] ?> </td>
                            <td class="px-4 py-3"><?php echo $row['title'] ?></td>
                            <td class="px-4 py-3"><img class="w-32"  src="img/<?php echo $row['img'] ?>" alt=""></td>
                            <td class="px-4 py-3"><?php echo $row['intro'] ?> </td>
                            <th class="py-3 px-4 text-left"><a href="update_new.php?new_id=<?php echo $row['new_id']  ?>"> Sửa</a></th>
                            <th class="py-3 px-4 text-left"> <a href="delete_new.php?new_id=<?php echo $row['new_id']?>">Xóa</a></th>
            ...
            <a class="p-4 border-2 m-8 bg-cyan-400 inline-block" href="addnew.php">Thêm tin tức</a>
    </div>
